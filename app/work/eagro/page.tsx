  ...
  return (
    <>
      ...
      <div style={{ width: '100%', height: '786px', overflow: 'hidden' }}>
          <img src="/eagro-intro.jpg" alt="ArchiveX Platform" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
      </div>
      ...
      <section style={sec}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: '6rem' }}>
          <div>
            ...
            <h2 style={{ fontFamily: 'var(--ff-display)', fontSize: '1.8rem', fontWeight: 500, lineHeight: 1.2 }}>An agricultural platform rebuilt for real decisions</h2>
          </div>
          <div>
            ...
            <p style={{ fontSize: '16px', lineHeight: 1.9, color: 'var(--muted)', fontWeight: 300 }}>
              The goal was not only to improve usability, but to establish a scalable system that integrates satellite intelligence into everyday decision-making — replacing subjective field assessment with an objective, shared source of truth.
            </p>
          </div>
        </div>
      </section>
      ...
      <section style={sec}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: '6rem', marginBottom: '3rem' }}>
          <div>
            ...
            <h2 style={{ fontFamily: 'var(--ff-display)', fontSize: '1.8rem', fontWeight: 500, lineHeight: 1.2 }}>Not missing features — missing clarity</h2>
          </div>
          <div>
            <p style={{ fontSize: '16px', lineHeight: 1.9, color: 'var(--muted)', fontWeight: 300, marginBottom: '1.5rem' }}>
            ...
            <p style={{ fontSize: '16px', lineHeight: 1.9, color: 'var(--muted)', fontWeight: 300 }}>
              Although the system offered powerful capabilities, users struggled to navigate and interpret the information efficiently. The same data appeared in different formats across roles, and workflows lacked clarity. The issue was not missing functionality, but the effort required to understand and use it.
            </p>
          </div>
        </div>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '1rem' }}>
          {[
            ...
            <div key={item.title} style={{ background: 'var(--cream)', border: '1px solid var(--border)', padding: '1.5rem' }}>
      ...
      <section style={sec}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: '6rem' }}>
          <div>
            ...
            <h2 style={{ fontFamily: 'var(--ff-display)', fontSize: '1.8rem', fontWeight: 500, lineHeight: 1.2 }}>A hybrid model — unified core, role-specific flows</h2>
          </div>
          <div>
            <p style={{ fontSize: '16px', lineHeight: 1.9, color: 'var(--muted)', fontWeight: 300, marginBottom: '1.5rem' }}>
      ...
      <section style={sec}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: '6rem', marginBottom: '3rem' }}>
          <div>
            <div style={{ fontSize: '11px', letterSpacing: '0.15em', color: 'var(--accent)', textTransform: 'uppercase', marginBottom: '1rem' }}>Positioning</div>
            <h2 style={{ fontFamily: 'var(--ff-display)', fontSize: '1.8rem', fontWeight: 500, lineHeight: 1.2 }}>From history to forecast — not instruction</h2>
          </div>
          <div>
            <p style={{ fontSize: '16px', lineHeight: 1.9, color: 'var(--muted)', fontWeight: 300, marginBottom: '1.5rem' }}>
              Eagro does not tell users what to do. It analyses accumulated field data — vegetation history, soil records, weather patterns, and outcomes from previous seasons — and projects what the coming season is likely to look like.
            </p>
            <p style={{ fontSize: '16px', lineHeight: 1.9, color: 'var(--muted)', fontWeight: 300 }}>
              This was a deliberate positioning decision. A prescriptive system that issues instructions carries responsibility it cannot hold. Eagro presents evidence and projection; the decision stays with the person who knows the field.
            </p>
          </div>
        </div>
      ...
      <section style={sec}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: '6rem' }}>
          <div>
            ...
            <h2 style={{ fontFamily: 'var(--ff-display)', fontSize: '1.8rem', fontWeight: 500, lineHeight: 1.2 }}>The foundation for scale</h2>
          </div>
          <div>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem' }}>
              {['Colour tokens', 'Typography scale', 'Component library', 'Interaction states', 'Data visualisation', 'Map layer controls', 'Form patterns', 'Spacing system'].map(tag => (
      ...
      <section style={{ ...sec, background: 'var(--dark)', color: 'var(--cream)', borderBottom: 'none' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: '6rem' }}>
          <div>
            ...
            <h2 style={{ fontFamily: 'var(--ff-display)', fontSize: '1.8rem', fontWeight: 400, lineHeight: 1.2 }}>Structuring complexity, not eliminating it</h2>
          </div>
          <div>
      ...
      {/* NEXT */}
      <Link href="/work/ingress-academy" className="next-link"
        ...
        <span style={{ fontFamily: 'var(--ff-display)', fontSize: '2rem', fontWeight: 500, letterSpacing: '-0.02em' }}>Ingress Academy →</span>
      </Link>
