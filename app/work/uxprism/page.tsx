...
export default function UXprism() {
  return (
    <>
      <style>{`
        @keyframes shimmer {
      ...
      <section style={{ minHeight: 'calc(100vh - 200px)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '5rem 2rem' }}>
        ...
        <div style={{ fontSize: '11px', letterSpacing: '0.2em', color: 'var(--accent)', textTransform: 'uppercase', marginBottom: '1.5rem' }}>SaaS · Design Tooling</div>
